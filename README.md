# AIR_Cargo_Analysis-Project-In-Sql
DESCRIPTION
...
Write a query to create route details table using suitable data types for the fields, such as route id, flight numb, origin airport, destination airport, aircraft id, and distance miles. Implement the check constraint for the flight number and unique constraint for the route id fields. Also, make sure that the distance miles field is greater than 0.
Create an ER diagram for the given AIR_INFORMATION database.
